...
const VisaStatus = ({ styles, country_tab, activeTab, active }) => {
                            ...
                            <div className="row">
                                <div className="col-md-8">
                                    <ul className={`${styles.TopMenu} nav flex-row nav-pills nav-pills-custom`} role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">Working Status</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">Submitted Status</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">Completed Status</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className={`col-10`}>
                                            <div className={styles.visaStatusDiv}>
                                                ...
                                                </div>                                                <div className={`form-group ${styles.fromGroup}`}>
                                                    <div className={styles.CheckBox}>
                                                        <input
                                                            name="checkbox"
                                                            type="checkbox"

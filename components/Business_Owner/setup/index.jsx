...
import VisaStatus from "./visa_status";
  ...
  return (
    <Fragment>
      <div className={styles.contentWrapper}>
        <div className={styles.pageDetailArea} style={{marginTop:"10px"}}>
          ...
          <div className="row">
            <div className={`col-lg-12 pr-0  setting leftMenu `}>
              ...
              >
                <a
                  onClick={getBilling}
                  className={`nav-link  shadow ${active_profile_tab ? styles.active : ""
                    }`}
                ...
                <a
                  ...
                  className={`nav-link  shadow ${active_country_tab ? styles.active : ""
                    }`}
                ...
                <a
                  onClick={getFAQ}
                  className={`nav-link  shadow ${active_visa_type_tab ? styles.active : ""
                    }`}
                  id="v-pills-visa-tab"
                  data-toggle="pill"
                  href="#v-pills-visa"
                ...
                <a
                  onClick={getAbout}
                  className={`nav-link  shadow ${active_template_tab ? styles.active : ""
                    }`}
                ...
                <a
                  onClick={getLanguage}
                  className={`nav-link  shadow ${active_appointment_tab ? styles.active : ""
                    }`}
